...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/rider',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'RIDER') : const RiderWidget(),
        ),
        FFRoute(
          name: 'SETUP_PROFILE',
          path: '/setupProfile',
        ...
        FFRoute(
          name: 'DELIVERED',
          path: '/delivered',
          builder: (context, params) => const DeliveredWidget(),
        ),
        FFRoute(
          name: 'REPORT',
          path: '/report',
        ...
        FFRoute(
          name: 'CREATE_REPORT',
          path: '/createReport',
          builder: (context, params) => const CreateReportWidget(),
        ),
        FFRoute(
          name: 'LANDING',
          path: '/landing',
