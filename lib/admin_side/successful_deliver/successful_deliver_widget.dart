...
import 'successful_deliver_model.dart';
export 'successful_deliver_model.dart';

class SuccessfulDeliverWidget extends StatefulWidget {
  const SuccessfulDeliverWidget({super.key});

  @override
  State<SuccessfulDeliverWidget> createState() =>
      _SuccessfulDeliverWidgetState();
}

class _SuccessfulDeliverWidgetState extends State<SuccessfulDeliverWidget> {
  late SuccessfulDeliverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuccessfulDeliverModel());
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Fueling triumph one flawless delivery at a time – where success isn\'t just a goal, it\'s our unwavering commitment to excellence. ',
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                                  fontFamily: 'Inter Tight',
