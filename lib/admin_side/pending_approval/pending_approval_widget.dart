import '/admin_side/for_approval/for_approval_widget.dart';
...
class _PendingApprovalWidgetState extends State<PendingApprovalWidget> {
  late PendingApprovalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PendingApprovalModel());
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          'Review rider delivery proof before confirming the item has been successfully delivered ',
                          style:
                                                                    ...
                                                                    Stack(
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Image.network(
                                                                            notEmptyDeliveryRecord.riderPhoto,
                                                                            fit:
                                                                                BoxFit.cover,
                                                                          ),
                                                                        ),
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return GestureDetector(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: ForApprovalWidget(
                                                                                    forApproval: notEmptyDeliveryRecord.reference,
                                                                                  ),
                                                                                ),
                                                                              );
                                                                            },
