...
Future maybeCreateUser(User user) async {
  ...
  if (userExists) {
    currentUserDocument = await AdminRecord.getDocumentOnce(userRecord);
    return;
  }
  ...
  currentUserDocument = AdminRecord.getDocumentFromData(userData, userRecord);
}

Future updateUserDocument({String? email}) async {
  await currentUserDocument?.reference
      .update(createAdminRecordData(email: email));
}
